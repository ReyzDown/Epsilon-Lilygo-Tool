...
esp_err_t Deauther::esp32_deauther_configure_wifi(uint8_t channel) {
    ...
    // Paramètres de la configuration AP
...
esp_err_t Deauther::deauth(const MacAddr ap, const MacAddr station,
...
void Deauther::spam_task(){

    const MacAddr TARGET = {
      //replace with the mac address of ur target F8-5E-A0-0B-41-86
      0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF
    };
    const MacAddr AP = {
      //replace with your AP's mac address A0:B7:65:67:F3:0C
